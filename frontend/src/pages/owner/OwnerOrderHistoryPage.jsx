...
// Shows every order that has finished its lifecycle for this restaurant —
// delivered or cancelled — separated out from OwnerDashboardPage's active
// orders list so completed history doesn't clutter the "needs attention"
// view. Reuses the exact same GET /api/restaurant/orders endpoint the
// dashboard already uses; no backend change needed for this page.
            ...
            {loading ? (
                ...
                <div className="bg-surface border border-border rounded-lg p-6">
                    <p className="text-sm text-muted">
                        No completed orders yet. Delivered and cancelled
